import require$$0, { openBlock, createElementBlock, createElementVNode, createCommentVNode, Fragment, renderList, toDisplayString, normalizeClass, resolveDirective, withDirectives, resolveComponent, createBlock, withKeys, withModifiers, normalizeStyle, vModelText, createVNode, vModelRadio, vModelCheckbox, mergeProps, createTextVNode, resolveDynamicComponent, renderSlot } from 'vue';
...
class LanguageModel {
  constructor(options) {
    ...
    this.errorAllowedFileTypes =
      "Invalid file type. Allowed file types: :fileTypes.";
    this.errorMaxFileSize =
      "File(s) too large. Maximum allowed file size: :size.";
...
const _hoisted_5$4 = /*#__PURE__*/createElementVNode("span", { class: "f-arrow-down" }, [
...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_the_mask = resolveComponent("the-mask");
    ...
    (_ctx.question.mask)
      ...
      : (openBlock(), createElementBlock("input", {
          ...
          onKeyup: [
            ...
            _cache[2] || (_cache[2] = withKeys(withModifiers((...args) => (_ctx.onEnter && _ctx.onEnter(...args)), ["prevent"]), ["enter"])),
            _cache[3] || (_cache[3] = withKeys(withModifiers((...args) => (_ctx.onEnter && _ctx.onEnter(...args)), ["prevent"]), ["tab"]))
          ],
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_textarea_autosize = resolveComponent("textarea-autosize");
    ...
    createElementVNode("ul", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.question.options, (option, index) => {
        return (openBlock(), createElementBlock("li", {
          onClick: withModifiers($event => ($options.toggleAnswer(option)), ["prevent"]),
      ...
      (!$data.hasImages && _ctx.question.allowOther)
        ? (openBlock(), createElementBlock("li", {
            ...
            onClick: _cache[5] || (_cache[5] = withModifiers((...args) => ($options.startEditOther && $options.startEditOther(...args)), ["prevent"])),
            ...
            createElementVNode("div", _hoisted_9$3, [
              ...
              ($data.editingOther)
                ? withDirectives((openBlock(), createElementBlock("input", {
                    ...
                    onKeyup: [
                      _cache[2] || (_cache[2] = withKeys(withModifiers((...args) => ($options.stopEditOther && $options.stopEditOther(...args)), ["prevent"]), ["enter"])),
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("input", {
    ...
    required: _ctx.question.required,
    onKeyup: [
      _cache[0] || (_cache[0] = withKeys(withModifiers((...args) => (_ctx.onEnter && _ctx.onEnter(...args)), ["prevent"]), ["enter"])),
      _cache[1] || (_cache[1] = withKeys(withModifiers((...args) => (_ctx.onEnter && _ctx.onEnter(...args)), ["prevent"]), ["tab"]))
    ],
...
const _hoisted_2$3 = /*#__PURE__*/createElementVNode("td", null, null, -1 /* HOISTED */);
...
const _hoisted_10$2 = /*#__PURE__*/createElementVNode("span", { class: "f-field-mask f-radio-mask" }, [
  /*#__PURE__*/createElementVNode("svg", {
    viewBox: "0 0 24 24",
...
const _hoisted_14$2 = /*#__PURE__*/createElementVNode("span", { class: "f-field-mask f-checkbox-mask" }, [
  /*#__PURE__*/createElementVNode("svg", {
    viewBox: "0 0 24 24",
    ...
    createElementVNode("table", {
      ...
      createElementVNode("thead", null, [
        createElementVNode("tr", null, [
          _hoisted_2$3,
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.question.columns, (column, index) => {
      ...
      createElementVNode("tbody", null, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.question.rows, (row, index) => {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", null, [
    createVNode(_component_vue_slider, mergeProps({
      ...
      ($options.showClearButton)
        ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
            createElementVNode("a", {
              href: "#",
              onClick: _cache[2] || (_cache[2] = withModifiers((...args) => ($options.clear && $options.clear(...args)), ["prevent"])),
              "aria-label": _ctx.language.ariaClear
            }, [
              createElementVNode("span", null, toDisplayString(_ctx.language.clear), 1 /* TEXT */)
...
const _hoisted_6$1 = /*#__PURE__*/createElementVNode("span", { "aria-hidden": "true" }, "*", -1 /* HOISTED */);
const _hoisted_7$1 = [
  _hoisted_6$1
];
const _hoisted_8$1 = {
        ...
        ($props.question.description || $props.question.descriptionLink.length !== 0)
          ? (openBlock(), createElementBlock("p", _hoisted_15$1, [
              ($props.question.description)
                ...
                : createCommentVNode("v-if", true),
              (openBlock(true), createElementBlock(Fragment, null, renderList($props.question.descriptionLink, (link, index) => {
      ...
      ($options.showOkButton())
        ? (openBlock(), createElementBlock("div", _hoisted_18$1, [
            createElementVNode("button", {
              ...
              ref: "button",
              href: "#",
              onClick: _cache[2] || (_cache[2] = withModifiers((...args) => ($options.onEnter && $options.onEnter(...args)), ["prevent"])),
            ...
            ($props.question.type !== $data.QuestionType.LongText || !_ctx.isMobile)
              ? (openBlock(), createElementBlock("a", {
                  ...
                  class: "f-enter-desc",
                  href: "#",
                  onClick: _cache[3] || (_cache[3] = withModifiers((...args) => ($options.onEnter && $options.onEnter(...args)), ["prevent"])),
...
const _hoisted_14 = /*#__PURE__*/createElementVNode("svg", {
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "xmlns:xlink": "http://www.w3.org/1999/xlink",
  x: "0px",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_flow_form_question = resolveComponent("flow-form-question");

  return (openBlock(), createElementBlock("div", {
    class: normalizeClass(["vff", {
    ...
    createElementVNode("div", _hoisted_1, [
      createElementVNode("div", _hoisted_2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($data.questionList, (q, index) => {
        ...
        ($options.isOnLastStep)
          ? (openBlock(), createElementBlock("div", _hoisted_3, [
              ...
              renderSlot(_ctx.$slots, "completeButton", {}, () => [
                ...
                (!$data.submitted)
                  ? (openBlock(), createElementBlock("button", {
                      ...
                      type: "button",
                      href: "#",
                      onClick: _cache[0] || (_cache[0] = withModifiers($event => ($options.submit()), ["prevent"])),
                ...
                (!$data.submitted)
                  ? (openBlock(), createElementBlock("a", {
                      ...
                      class: "f-enter-desc",
                      href: "#",
                      onClick: _cache[1] || (_cache[1] = withModifiers($event => ($options.submit()), ["prevent"])),
                      innerHTML: $props.language.formatString($props.language.pressEnter)
      ...
      createElementVNode("div", _hoisted_10, [
        ($props.progressbar)
          ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(["f-progress", {
        ...
        ($props.navigation)
          ? (openBlock(), createElementBlock("div", _hoisted_12, [
              createElementVNode("a", {
                class: normalizeClass(["f-prev", {
              'f-disabled': $data.activeQuestionIndex === 0 || $data.submitted,
            }]),
                href: "#",
                onClick: _cache[2] || (_cache[2] = withModifiers($event => ($options.goToPreviousQuestion()), ["prevent"])),
                role: "button",
              ...
              createElementVNode("a", {
                ...
                href: "#",
                onClick: _cache[3] || (_cache[3] = withModifiers($event => ($options.goToNextQuestion()), ["prevent"])),
                role: "button",
...
export { ChoiceOption, script$1 as FlowForm, LanguageModel, LinkOption, MarkOption, MaskPresets, MatrixColumn, MatrixRow, script as Question, QuestionModel, QuestionType };
